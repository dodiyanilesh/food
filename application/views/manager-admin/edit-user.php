        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="white-box">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" name="first_name" id="first_name" value="<?php echo $user->first_name; ?>" required="required" class="form-control form-control-line"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Last Name</label>
                        <div class="col-md-12">
                            <input type="text" name="last_name" id="last_name" value="<?php echo $user->last_name; ?>" required="required" class="form-control form-control-line"> 
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" name="email" id="email" required="required" value="<?php echo $user->email; ?>" class="form-control form-control-line"> 
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-12">Password <span style="font-weight:normal; font-style:italic;">(if want to change then enter otherwise leave blank)</span></label>
                    <div class="col-md-12">
