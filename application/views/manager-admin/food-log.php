                    ...
                    <div class="col-md-12">
                        ...
                        <div class="foodlog">
                            ...
                            <div class="foods-dropdown-menu-main">
                                <ul class="foods-dropdown-menu foods-menu-add-list"></ul>
                            </div>
                            </div>
                            ...
                            <div class="log-panel">
                                ...
                                <div class="form-group" style="margin-top:30px;">
                                    <a href="<?php echo base_url('manager-admin/generate_report/'.$user_id.'/'.date('d-m-Y')); ?>" class="btn btn-primary">Generate Food Chart</a>
                                </div>
             ...
             <div class="modal-dialog modal-label" role="document">
                 <div class="modal-content">
                     <div class="modal-header">
                        ...
                        <div class="modal-body">
                         <form class="review-food-form clear" id="myForm">
                             <div class="search-box">
                                 <div class="input-group">
                                ...
                                <div class="item-total-calories row">
                                 <div class="item-calorie" id="totalCalories">130</div>Total Calories
                                </div>
                                <div class="macronutrients row">
                                    <div id="totalProtein" class="col protein">0g<span>Protein</span></div>
                                    <div id="totalCarbs" class="col carb">0g<span>Carbs</span></div>
                                    <div id="totalFat" class="col fat">0g<span>Fat</span></div>
                                    <div id="totalSodium" class="col sodium">0mg<span>Sodium</span></div>
                                    
                                    <input type="hidden" name="totalpost_Calories" id="totalpost_Calories" value="">
                                    <input type="hidden" name="totalpost_Protein" id="totalpost_Protein" value="">
                                    <input type="hidden" name="totalpost_Carbs" id="totalpost_Carbs" value="">
                                    <input type="hidden" name="totalpost_Fat" id="totalpost_Fat" value="">
                                    <input type="hidden" name="totalpost_Sodium" id="totalpost_Sodium" value="">
                                    
                                    <input type="hidden" name="totalpost_saturated" id="totalpost_saturated" value="">
                                    <input type="hidden" name="totalpost_dietary_fiber" id="totalpost_dietary_fiber" value="">
                                    <input type="hidden" name="totalpost_cholesterol" id="totalpost_cholesterol" value="">
                                    <input type="hidden" name="totalpost_sugars" id="totalpost_sugars" value="">

                                    <input type="hidden" name="totalpost_vitamin" id="totalpost_vitamin" value="">
                                ...
                                <div class="when-data">
                                    ...
                                    <div class="meal-at">
                                        <div class="btn-group colors" data-toggle="buttons">
                                          <label class="btn btn-default active">
                                            <input type="radio" name="meal" value="Breakfast" autocomplete="off" checked> Breakfast
                                          </label>
                                          ...
                                          <label class="btn btn-default">
                                            ...
                                            <label class="btn btn-default">
                                            <input type="radio" name="meal" value="Morning Snacks" autocomplete="off"> Morning Snacks
                                          </label>
                                            <label class="btn btn-default">
                                            <input type="radio" name="meal" value="Afternoon Snacks" autocomplete="off"> Afternoon Snacks
                                          </label>
                                            <label class="btn btn-default">
                                            <input type="radio" name="meal" value="Additional Snacks" autocomplete="off"> Additional Snacks
                                          </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="log-button" style="margin-top:20px;">
                                        <!-- <div class="btn btn-block btn-success">Log Food</div>
                                         --> 
                                        <button class="btn btn-block btn-success" id="food_store" type="submit">Log food</button>
                                    </div>
                                </div>
                            </form>
                        </div>
