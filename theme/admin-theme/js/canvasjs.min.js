...
g.size=Math.max(1.5*g.size<<0,10),g.borderColor=g.borderColor||"#000000",g.borderThickness=g.borderThickness||Math.ceil(0.1*g.size),P.drawMarkers([g]),"undefined"!==typeof f.y2&&(g=c.getMarkerProperties(h,f.x1,f.y2,this.chart.overlaidCanvasCtx),g.size=Math.max(1.5*g.size<<0,10),g.borderColor=g.borderColor||"#000000",g.borderThickness=g.borderThickness||Math.ceil(0.1*g.size),P.drawMarkers([g]))):"bubble"===c.type?(g=c.getMarkerProperties(h,f.x1,f.y1,this.chart.overlaidCanvasCtx),g.size=f.size,g.color=
